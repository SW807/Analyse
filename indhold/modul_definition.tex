...
For at gøre systemet fleksibelt så det er let at tilføje moduler til applikationen, har vi udtænkt en modul-baseret arkitektur.\ivan{Dette hensyn bør også omtales i starten af kapitlet. Det er jo helt centralt}
...
For eksempel vil det ikke være muligt at kontrollere hvilke database tabeller der er adgang til.
\ivan{Gode overvejelser. Er sikkerhedsproblemet både stort og uløseligt?}
...
Denne metode er valgt i dette projekt.
Det følgende vil forklare detaljerne i implementationen af moduler ved hjælp af selvstændige apps.

\ivan{Er dette en sgratis frokost? Hvad er prisen for dette valg?}
...
\stefan{moduldefinitionerne er så vidt jeg ved lavet om, og dette bør revideres}
\subsection{Typer af moduler}
\ivan{Henvis til det overordnede design her}
