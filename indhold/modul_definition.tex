...
``Komplet pakke'' løsningen giver en nem måde at kunne kommunikere mellem moduler på den måde at de kan kontakte hinanden direkte fordi de er i samme pakke.
...
Derudover gør løsningen også at udviklingen af systemet bliver begrænset, på den måde at det kun er udviklerne af hovedapplikationen der har mulighed for at ændre på systemet.
...
På samme tid skal man også overveje sikkerheds bekymringer, idet at hvis koden der bliver importeret er ondsindet kan dette give problemer såsom at data kan blive stjålet. 
...
Endvidere bruger analyse moduler data fra enten data-moduler eller andre analyse-moduler til at bearbejde data med den hensigt at opnå en opsummering af data, som videre kan bruges af systemet til enten visualisering eller videre bearbejdning.
...
JSON blev valgt over XML fordi automatisk generering ud fra et skema var ønsket.
En automatisk genereret parser var ønsket af den grund at det vil gøre det nemmere at ændre på et skemaet uden at skulle manuelt opdatere den tilhørende klasse, idet at det ville ske automatisk.
...
\stefan{Ivan havde svært ved at følge argumentationen. Lasses har rettet det siden, men jeg foreslår at vi helt skrotter afsnittet. Det giver ikke noget til forståelsen af platformen.}
