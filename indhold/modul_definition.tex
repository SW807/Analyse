...
Som sagt er sensormoduler, moduler som indsamler data fra telefonens forskellige sensorer og applikationer.
Endvidere er analysemoduler, moduler der bearbejder data fra enten sensor- eller andre analysemoduler med den hensigt at opnå en opsummering af data som kan bruges af systemet til enten visualisering eller videre bearbejdning af andre analysemoduler.
Visningsmodulerne bruges til visualisering af den rå sensor-data eller den behandlede analyse-data.
