...
JSON blev dog valgt over XML fordi automatisk generering ud fra et skema var ønsket.
En automatisk genereret parser var ønsket af den grund at det vil gøre det nemmere at ændre på et skema uden manuelt at skulle opdatere den tilhørende klasse, idet at det ville ske automatisk.
...
\lars{jeg er uenig i at skrotte det, kan godt være det ikke giver noget til forståelse, men det er argumentation for et af vores valg, hvilket er vigtigt}
