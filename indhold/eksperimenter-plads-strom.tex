...
\lars{Overvej om dette er korrekt placering}
...
Implementation af en eller flere af disse strategier vil kunne reducere den gemte data, men det vil muligvis stadig være for meget til at data kan holdes på smartphonen i længere perioder.
