...
\als{Nu bruger vi komprimering. Skal vi ikke vise en anden tabel med det? og gentage eksperimentet}
...
Lyd modulet var på eksperimenttidspunktet meget simpelt, og gemte kun amplituden af den optagne lyd i databasen. 
Af denne grund fylder lyd modulets data i denne test ikke mere end 4 \% af databasen.
...
Det er naivt at lagre dataet i diskret form, hvorfor diverse metoder til aggregering af data diskuteres herunder.
...
Hvis et sådant problem stadig eksisterer, er en udvidelse med server klient arkitektur en mulighed.\als{Skriv gerne to ord om hvad det indebærer.}