...
Hvis pladsforbruget viser sig for stort skal data enten komprimeres eller man bør overveje muligheden for ekstern lagring.
...
Det er naivt at lagre dataet i diskret form, hvorfor diverse metoder til aggregering af data diskuteres under \cref{sec:opryd}.
