...
Eksperimenterne blev udført på en Samsung Galaxy S4 hvor følgende datakilder lagrede i den samme SQLite database:
...
Dette vil også muliggøre at have analyser kørende i skyen, hvis den mobile enhed ikke har beregningskraft \lars{bedre ord end beregningskraft} nok.
