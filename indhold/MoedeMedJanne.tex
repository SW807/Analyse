...
\stefan{bør flettes sammen med \secref{sec:affektivelidelser}}
...
Hvad vores fokus kunne være at se på advarsels tegn af tilbagevendende mani- eller depressions-periode , hvor man f.eks. kunne se på døgnrytme hvor unipolare sover for meget og bipolare sover for lidt i mani-perioder men kan også opleve depressive perioder hvor de sover for meget.

Det er vigtigt at identificere søvn da det siger meget om deres situation, og ud fra søvn baseret på ændringer kunne man identificere om de er på vej ind i en mani- eller depressions-periode og om de er på vej ud af den periode. 
...
\item[Lokation]
	...
	Dog kan det nok godt bruges til bipolare patienter, da når de er i en mani-periode vil de være mere omkringfarende. 
...
\item[Lyd]
	Idéen her er at bruge en baggrunds optager i smartphonen og derefter analysere personens tale, som f.eks. stemmeleje. 
...
\item[Opkaldsoversigt]
	...
	Dette ville kunne bruges til bipolare lidelser da når de er i mani-erioder vil de være meget sociale og derfor snakke meget. 
...
\item[Applikation brug]
	Idéen er at analysere på hvilke applikationer der oftest bliver brugt på smartphonen. Her ville man kunne se på trends og forholde brug til det habituelle niveau og på samme tid ville der nok være god idé om patientens brug af smartphonen ændrer sig.
...
\item[Puls]
	...
	Forbundet med brug af hardware som JawBone ville der være en positiv side effekt idet patientens kendskab til at man bliver overvåget af en JawBone el. andet vil være en motiverende faktor for mange patienter. 
\item[Søvnmønstre]
	Idéen  er at man analysere patienternes søvnmønstre ved at måle når skærmen tændes, da de fleste slukker skærmen på siden smartphone når man går i seng og tænder den når man står op. 
...
\item[Andre]
	Ud fra de ting der blev snakket om, blev samtalen også vendt mod nogle ting der ikke var tænkt på, hvilket var at segmentere patienterne på hvordan de bruger deres smartphone, 
