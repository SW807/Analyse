...
\item Android applikationer udvikles som regel i Java, hvilket er et meget \textbf{bredt brugt} programmeringssprog.
\end{itemize}
\ivan{GUL RETTELSE}

Android har dog forskellige ulemper, \textbf{som at} der er mange forskellige smartphones med forskellig hardware og forskellige versioner af operativ systemet. 
\ivan{GUL RETTELSE}
...
Vores projekt er meget afhængig af åben adgang til datakilder, hvilket Android giver bedre adgang til. Vores situation er også at udvikling på Android virker nemmere da det ikke påkræver et specielt operativ system da ingen på udviklingsholdet har OS X computere, og at udvikling i Java er kendt blandt mange på udviklingsholdet. \textbf{Grunden til at Windows Phone ikke blev valgt er at meget få som bruger platformen i forhold til Android.}
\ivan{Gentagelse}