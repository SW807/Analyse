...
Dette udnyttes ved at pakke alle moduler i hver deres selvstændige app.
...
\mikkel{Jeg forstår ikke meningen med den sidste sætning.}
...
I vores tilfælde af den data der deles den som DB Access råder over.
\mikkel{Bør DB Access ikke være implementationen af facade? DB Access råder ikke over data, men håndterer adgang.}
...
\stefan{ideer?}
\mikkel{Samme kommentar som tidligere - jeg synes det er det forkerte sted at have 'fremtidig udvikling'}
