...
\paragraph{Platform}
Projektet har valgt at bruge Android som platform, se \cref{sec:valg_af_android}, hvilket også lægger op til nogle overvejelser ift. arkitektur.
...
\lars{tror ikke dette bør nævnes, da det sådanset er hvad den næste section indeholder}
...
\stefan{skal det nævnes at dette ikke er impl?}
...
Til at benytte facade designmønstret gøres der brug af \textit{ContentProvider} \citep{contentprovider}, der er et interface som Android stiller tilrådighed.
