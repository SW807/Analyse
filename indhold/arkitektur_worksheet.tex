...
\bruno{Hvad skal der være mere om?}
...
\paragraph{Design}
Til hvert enkelt modul hører en modulbeskrivelse (beskrevet i \cref{modul_definition}) der beskriver modulets afhængigheder af andre moduler samt hvordan det skal administreres i systemet.
...
Modullaget inddeles yderligere i tre konceptuelle lag: \textit{data}-, \textit{analyse}- og \textit{visualiserings}-moduler.
