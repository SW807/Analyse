...
\textit{DB access} kan tænkes som en facade, der sikrer adgangskontrol til databasen og sikrer at det er nemt at læse og skrive til \textit{DB}.
...
Dette er dog ikke muligt da \textit{DB Access} bruger en \textit{ContentProvider}, men er det ikke muligt at se hvad for en anden applikation der tilgår \textit{DB Access}, hvilket gør at denne begrænsning ikke er mulig. \ivan{Klodset og redundant sprog}
...
Bemærk at de tre lag i modul-komponenten er rent konceptuelt, da på implementationsniveau skelnes der ikke mellem disse.\als{Måske er view anderledes på implementationsniveau også}
