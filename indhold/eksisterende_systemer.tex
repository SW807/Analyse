...
Uden wearables eller apps ud over Google Fit app'en, indsamles der kun bevægelses-data fra fx. GPS, hvor der app'en selv estimerer om man går, løber eller cykler.
Ellers skal man manuelt indtaste aktiviteter og deres varighed, såsom styrketræning, roning, etc.

%google fit begreber og muligheder
...
\subsubsection{Problemer}
%google fit terms and conditions

%apple health ingen deling til andre personer

%ms health ingen android sdk
