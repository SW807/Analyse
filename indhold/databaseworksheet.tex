...
Delete kan blive relevant til brug ved oprydning af for gammel data. Da vi fokuserer på at analysere på mønstre i dataene kunne man eksempelvis slette sensor data der er ældre end 2 måneder. \ivan{Alder på data til sletning vil måske afhænge af type af data (bevægelsesdata kan måske slettes efter kort tid, og sociale interaktionsdata skal måske leve længere)}
