...
Platformen er meget modulær idet at det er simpelt at tilføje nye moduler til den. % Styrke
Dette har dog den betydning at brugeren skal potentielt installere mange applikationer, hvilket selvfølgelig kan være forvirrende hvis de ikke ved hvad de skal bruge. %svaghed
...
Idet at platformen tillader dette er det en styrke. % Styrke
...
Det kan dog gøres et argument for at det er for åbent, idet at alt for meget data deles og ikke bare hvad modulerne skal bruge. 

Platformen bruger en masse løsninger til problemer såsom deling af ressource filer, som ikke er de hensete løsninger men de problemer der blive mødt virkede ikke til at have 'officielle' løsninger. 
Et eksempel på dette kunne for eksempel være måden de installerede moduler bliver fundet af platformen, idet at måden dette gøres på er at platformen forespørger en liste over alle applikationer som er installeret på den smartphone som den ligger på. 