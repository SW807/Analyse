...
\subsection{Affektive Lidelser}\label{sec:affektivelidelser}
...
Udover dette kan misbrug samt bestemte former for medicin brug forårsage mani og depression.
...
\citet{misc:netpsykdepression} klassificerer en depression enkeltperiode ud fra en række kriterier, der nævnes herefter.
\paragraph{Depression kriterier}
...
\paragraph{Grader af depression}
...
\paragraph{Individuelle Symptomer}
