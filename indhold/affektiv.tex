...
Denne sektion er primært baseret på \citep{misc:affektivelidelser, misc:netpsykdepression, misc:netpsykmani}.
...
En ubehandlet sygdom varer almindeligvis seks til tolv måneder, men kroniske depressioner findes med op til flere års varighed er ikke ualmindelige, især hos ældre\citep{misc:affektivelidelser}.
...
\citep{misc:netpsykdepression} klassificerer en depression enkeltperiode udfra en række kriterier, der nævnes herefter.
...
\begin{itemize}
	\item Man har nedsat selvtillid eller selvværdsfølelse\item Man lider af skyldfølelse og bebrejder sig selv urimeligt
...
\citep{misc:netpsykmani} klassificerer en manisk enkeltepisode uden psykotiske symptomer som at man i mere end en uge skal opfylde følgende:
\begin{itemize}
...
Den oftest sete er en mani episode og flere depressions episoder, men andre scenarier kan også forekomme.
