...
\input{indhold/arkitekturmoenstre}
...
\lars{flyttet fra arkitektur til hvad der virker til at være implementation, måske stadig forkert sted}
\input{indhold/Managervidere}

\subsection{Data lag}
\input{indhold/databaseworksheet}
\subsubsection{Fremtidig udvikling}\lars{flyttet fra arkitektur til hvad der virker til at være implementation, måske stadig forkert sted}
\input{indhold/datavidere}

\section{Modul-definition}\label{modul_definition}
\input{indhold/modul_definition}
\input{indhold/modul_view}
\input{indhold/modulvidere}\lars{flyttet fra arkitektur til hvad der virker til at være implementation, måske stadig forkert sted}
