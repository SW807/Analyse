...
\newcommand{\aautitlepage}[3]{%
  {
    ...
    \vfill
    \iflanguage{danish}{%
      \noindent{\footnotesize\emph{Rapportens indhold er frit tilgængeligt, men offentliggørelse (med kildeangivelse) må kun ske efter aftale med forfatterne. \textbf{\textcolor{red}{Rapporten er udarbejdet som en fællesrapport, skrevet af begge grupper.}}}}
    }{%
